...
$upload_dir_web = "../public/uploads/projects/"; // Path for img src
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Optional: Validate date logic (e.g., end_date after start_date)
    ...
    if (empty($error_msg)) {
        ...
        $sql = "INSERT INTO projects (name, description, start_date, end_date, status, image_url) VALUES (
                '" . $name . "',
                '" . $description . "',
                " . $start_date_sql . ",
                " . $end_date_sql . ",
            ...
            <div class="card-body">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="status" name="status" placeholder="e.g., Ongoing, Completed, Planned" value="<?php echo isset($_POST['status']) ? htmlspecialchars($_POST['status']) : ''; ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="image">Project Image (Optional, Max 5MB: JPG, JPEG, PNG, GIF)</label>
