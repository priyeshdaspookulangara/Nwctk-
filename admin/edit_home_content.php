...
$page_name_db = "home"; // Identifier for this page in the database
$msg = "";
$error_msg = "";
$content = "";
...
if ($result_fetch && mysqli_num_rows($result_fetch) > 0) {
    ...
    $placeholder_content = "Default Home Page Content. Please edit this.";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['page_content_update'])) {
        ...
        // Check if page_name exists, if not, INSERT, else UPDATE
        ...
        if ($check_result && mysqli_num_rows($check_result) > 0) {
            ...
            if (mysqli_query($conn, $update_sql)) {
                $msg = "Home page content updated successfully!";
                $content = $_POST['content_area']; // Show the newly submitted content (unsanitized for display in textarea)
            } else {
                $error_msg = "Error updating content: " . mysqli_error($conn);
            }
        } else {
            // This case should ideally be handled by the initial fetch and placeholder creation
            $insert_sql = "INSERT INTO page_content (page_name, content) VALUES ('" . sanitize_input($conn, $page_name_db) . "', '" . $new_content . "')";
            if (mysqli_query($conn, $insert_sql)) {
                $msg = "Home page content saved successfully!";
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit Content for Home Page</h3>
            </div>
            <div class="card-body">
                <?php if (!empty($msg)): ?>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="content_area" name="content_area" rows="15"><?php echo htmlspecialchars($content); // Display fetched or updated content ?></textarea>
                        <small class="form-text text-muted">You can use basic HTML tags for formatting (e.g., &lt;p&gt;, &lt;b&gt;, &lt;i&gt;, &lt;br&gt;, &lt;h1&gt;-&lt;h6&gt;, &lt;ul&gt;, &lt;li&gt;, &lt;a href='...'&gt;). Ensure your HTML is valid.</small>
                    </div>
